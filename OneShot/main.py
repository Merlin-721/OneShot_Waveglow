...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_dir', '-d', default='preprocess/data/')
    parser.add_argument('-train_set', default='train')
    parser.add_argument('-train_index_file', default='train_samples_128.json')
    parser.add_argument('-logdir', default='log/')
    parser.add_argument('--load_model', action='store_true')
    parser.add_argument('--load_opt', action='store_true')
    parser.add_argument('-store_model_path', default='models/')
    parser.add_argument('-load_model_path', default='models/')
